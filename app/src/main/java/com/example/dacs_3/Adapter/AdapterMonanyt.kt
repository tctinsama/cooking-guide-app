...
import com.example.dacs_3.UI.Monanyt
import com.example.dacs_3.UI.MtMonan
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class AdapterMonanyt: RecyclerView.Adapter<AdapterMonanyt.MonanViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MonanViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_monanyt, parent, false)
    ...
    private fun openFeedbackDialog(gravity: Int, context: Context) {
        ...
        btnCo.setOnClickListener(){
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                val monan = Monan( id, null,null,null,null, 0)
                if(id != null) {

                    val result = RetrofitClient.create().update_tt(id)
                }
            ...
            val intent = Intent(context, Monanyt::class.java)
